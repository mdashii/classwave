			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main col-8">
				<div class="container mt-5">
					<div class="text-center  p-3" style="background: linear-gradient(270deg, #006485 , #91E9EB);">
						<h3 style="color:white;">Select your Child:</h3>
						<select id="childid" name="childid" onchange="ajaxRequestToGetChildInfo()" class="form-select" style="background-color: white;">
							<?php
					...
					<div class="text-center">
						<table id="mychild" class="table table-bordered"></table>
					</div>
				</div>
