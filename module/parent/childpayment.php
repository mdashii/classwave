		...
		<div class="row">
			...
			<div class="container mt-5">
				<div class="text-center p-3" style="background: linear-gradient(270deg, #006485 , #91E9EB);">
					<h3 style="color:white;">Select your Child to see payment:</h3>
					<select id="childid" name="childid" class="form-select" onchange="ajaxRequestToGetChildPaymentInfo()" style="background-color: white;">
						<?php
				...
				<div class="text-center">
					<table id="mychildpayment" class="table table-bordered"></table>
				</div>
			</div>
