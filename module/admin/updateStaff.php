    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <h2 class="text-center">Only One Staff Can Update at a time.</h2>
                <h3 class="text-center">Please Search For A Specific Staff</h3>
                <form action="#" method="post" onsubmit="return newStaffValidation();" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="searchId" class="form-label"><b>Search By Id Or Name:</b></label>
                        <input type="text" class="form-control" name="searchId" id="searchId" placeholder="Search By Id Or Name:" onkeyup="getStaffForUpdate(this.value);">
                    </div>
                </form>
                <div class="table-responsive">
                    <table class="table table-bordered" id="updateStaffData">
