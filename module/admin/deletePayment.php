...
<body>
    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="mb-3">
                <label for="search" class="form-label"><b>Search By Payment Id Or Student Id</b></label>
                <input type="text" class="form-control" id="search" onkeyup="getPayment(this.value);">
            </div>
        </div>
    </div>
