    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <h2 class="text-center">Update Teacher Salary</h2>
                <div class="text-center">
                    <table class="table">
                        <tr>
                            <td><b>Search By Id Or Name:</b></td>
                            <td><input type="text" class="form-control" name="searchId" placeholder="Search By Id Or Name:" onkeyup="getTeacherForUpdateSalary(this.value);"></td>
                        </tr>
                    </table>
                </div>
                <br/>
                <div class="text-center">
                    <h2>Only One Teacher Salary Can Update at a time</h2>
                    <form action="#" method="post">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="updateTeacherSalary">
                                <!-- Update the table content here -->
                            </table>
                        </div>
                    </form>
                </div>
