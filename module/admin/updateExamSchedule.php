    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <h2 class="text-center">Update Exam Schedule</h2>
                <div class="text-center">
                    <table class="table">
                        <tr>
                            <td><b>Search By Id Or Name:</b></td>
                            <td><input type="text" class="form-control" name="searchId" placeholder="Search By Id Or Name:" onkeyup="getExamScheduleForUpdate(this.value);"></td>
                        </tr>
                    </table>
                </div>
                <br/>
