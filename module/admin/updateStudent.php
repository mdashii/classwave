        ...
        <nav id="sidebar " class="col-md-3 col-lg-2 col-4  sidebar ">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main col-8">
                ...
                <div class="container mt-5">
                    <div class="row justify-content-center">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="searchId" placeholder="Search By Id Or Name:" onkeyup="getStudentForUpdate(this.value);">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <h2 class="text-center">Only One Student Can Update at a Time.</h2>
                            <form action="#" method="post" onsubmit="return newStudentValidation();" enctype="multipart/form-data">
                                <div class="table-responsive">
                                    <table class="table table-bordered" cellpadding="6" id="updateStudentData">
