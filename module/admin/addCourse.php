    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <h2 class="text-center">Course Registration For Student</h2>
                <hr>
                <form action="#" method="post">
                    <table class="table table-bordered" cellpadding="6">
                        <tr>
                            <td>Class ID:</td>
                            <td>
                                <select class="form-select" id="className" onchange="getCourseNameAndId();"></select>
                            </td>
                        </tr>
                        <tr>
                            <td>Course Name:</td>
                            <td>
                                <select class="form-select" id="courseName" onchange="setCourseId()"></select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input type="button" class="btn btn-success" name="submit" value="Submit" onclick="getAllCourseStudentAndSubmit();">
                            </td>
                        </tr>
                    </table>
                </form>
