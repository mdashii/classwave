    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <h2 class="text-center">Only One Parent Can Update at a time.</h2>
                <form action="#" method="post" onsubmit="return newParentValidation();" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="searchId" id="searchId" placeholder="Search By Id Or Name:" onkeyup="getParentForUpdate(this.value);">
                    </div>
                </form>
                <table class="table table-bordered" id="updateParentData">
