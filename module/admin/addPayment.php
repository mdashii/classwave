    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="container mt-5">
                <h1 class="text-center">Student Tuition Fees</h1>
                <form action="#" method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="month" name="month" placeholder="Enter Month (e.g., April as 4).">
                    </div>
                    <div class="form-group">
                        <label for="year">Year:</label>
                        <input type="text" class="form-control" id="year" name="year" placeholder="Enter Year (e.g., 2016).">
                    </div>
